...
public class ReservationFormController implements Initializable {
	...
	public void onBtnSaveAction(ActionEvent event) {
		...
		try {
			entity = getFormData();
			Facade.inicializar();
			Facade.saveOrUpdateReservation(entity.getId(), entity.getReservationDate(), entity.getUser(), entity.getBook());
			Facade.finalizar();
	...
	private Reservation getFormData() {
		...
		obj.setReservationDate(LocalDate.ofInstant(instant, ZoneId.systemDefault()));
	...
	public void updateFormData() {
		...
		if (entity.getReservationDate() != null) {
			dpReservationDate.setValue(entity.getReservationDate());
		}
